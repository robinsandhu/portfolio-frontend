                    ...
                    <div className='contact-div contact-social'>
                        <div className={`nes-container with-title is-centered ${ displayMode ? "is-dark" : "" }`}>
                            ...
                            <div className="contact-icons">
                                ...
                                <a target="_blank" rel="noreferrer" href="mailto:er.robinsandhu@gmail.com">
                                    <i className="nes-icon gmail is-large"></i>
                                </a>
                                <a target="_blank" rel="noreferrer" href="https://medium.com/@robin-sandhu">
                                    <i className="nes-icon medium is-large"></i>
                                </a>
                                <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/robin-sandhu-b62010181/">
